...
1.  Enable the database secrets engine if it is not already enabled:
    ...
    Also, the majority of postgres docker images comes with "sslmode=disabled" by default. Remember to set
    the value to disable sslmode in the connection string if is that your case.
